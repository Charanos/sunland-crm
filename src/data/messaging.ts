...
export const MOCK_DMS: DmContact[] = [
  {
    ...
    lastMessage: "I've assigned the contractor for ticket #421.",
  ...
  },
  {
    ...
    name: "James Mutua",
    role: "Head of BD",
    avatarUrl: "https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?w=100&h=100&fit=crop&crop=faces",
  ...
  },
  {
    ...
    lastMessage: "Maintenance team dispatched to Westlands Tower.",
    lastMessageTime: "Yesterday",
    unread: 1,
    online: false,
  },
