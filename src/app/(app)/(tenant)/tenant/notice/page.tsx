...
export default function TenantNoticePage() {
  return (
    <ModulePage
      ...
      description="Give formal notice of your intention to vacate. Your notice triggers coordinated workflows: Finance (deposit reconciliation), Operations (inspection), and Property Management (re-letting). Deposit refund options are presented during the notice process."
