            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-[0_1px_4px_rgba(0,0,0,0.04)]">
              ...
              <div className="space-y-1">
                {[
                  ...
                  { label: "Security Centre", icon: IconShieldCheck, href: "/admin/security", desc: "2FA, audit log, access control" },
                  { label: "Notification Prefs", icon: IconBell, href: "/admin/settings", desc: "Manage alert preferences" },
                ].map(item => (
                  item.href ? (
