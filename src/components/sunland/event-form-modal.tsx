      ...
      <div className="space-y-5 mt-2 px-1">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-1 block">Date</label>
              <input
                type="date"
            ...
            <div>
              <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-1 block">Time</label>
              <input
                type="time"
                className={cn(
            ...
            <div>
              <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-1 block">Duration</label>
              <select
