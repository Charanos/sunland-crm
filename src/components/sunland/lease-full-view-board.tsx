    ...
    <div className="mx-auto flex max-w-[98rem] flex-col gap-6 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div id={`panel-${activeTab}`} role="tabpanel" aria-labelledby={`tab-${activeTab}`} className="mt-2">
            {activeTab === "overview" && (
              <div className="space-y-6">
                <Card className="bg-white border border-slate-100 rounded-[24px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_16px_40px_rgb(0,0,0,0.06)] transition-all">
                  <div className="flex items-center justify-between mb-8">
                    <h3 className="text-xl font-serif text-slate-900">Financial Terms</h3>
                    <div className="size-12 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-600 shadow-sm">
                      <IconShield size={24} stroke={1.5} />
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-3 p-7 rounded-2xl bg-slate-50 border border-slate-100 hover:border-slate-200 transition-colors">
                      <p className="text-xs font-bold uppercase tracking-wider text-slate-400 flex items-center gap-2">
                        <IconCalendarEvent size={16} /> Expected Monthly Rent
                      </p>
                      <p className="font-mono text-4xl text-slate-900 tracking-tight">{formatCompactKES(parseFloat(lease.monthlyRentKes))}</p>
                    </div>
                    <div className="flex flex-col gap-3 p-7 rounded-2xl bg-indigo-50/50 border border-indigo-100/50 hover:border-indigo-200/60 transition-colors">
                      <p className="text-xs font-bold uppercase tracking-wider text-indigo-400 flex items-center gap-2">
                        <IconShield size={16} /> Security Deposit Held
                      </p>
                      <p className="font-mono text-4xl text-indigo-900 tracking-tight">{lease.depositKes ? formatCompactKES(parseFloat(lease.depositKes)) : "—"}</p>
                    </div>
                  </div>
                </Card>
              </div>
            ...
            {activeTab === "activity" && (
              <Card className="bg-white border border-slate-100 rounded-[24px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                <div className="flex items-center justify-between mb-8">
                  <h3 className="text-xl font-serif text-slate-900">Audit Log</h3>
        ...
        <div className="flex flex-col gap-6 mt-1 lg:mt-0">
          <Card className="bg-white border border-slate-100 rounded-[24px] p-7 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_16px_40px_rgb(0,0,0,0.06)] transition-all">
            ...
            <div className="flex items-center gap-5">
              <div className="size-16 rounded-full bg-gradient-to-br from-slate-100 to-slate-200 border border-slate-200/60 flex items-center justify-center text-slate-700 text-xl font-medium shrink-0 shadow-inner">
                {getInitials(lease.tenantName)}
              </div>
              <div className="flex flex-col min-w-0">
                <p className="text-xl font-serif text-slate-900 truncate mb-1">{lease.tenantName}</p>
          ...
          <Card className="bg-white border border-slate-100 rounded-[24px] p-7 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_16px_40px_rgb(0,0,0,0.06)] transition-all flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between p-5 bg-slate-50 rounded-xl border border-slate-100 relative overflow-hidden">
              ...
              <div className="flex flex-col gap-1.5">
                <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Commencement</span>
              ...
              <div className="flex flex-col gap-1.5 text-right relative z-10">
                <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Expiration</span>
